...
srows = [("MINI BARN MARKET — SMALL AG. STORE 12'x10'","AS-BUILT","110 SF", 0),
         ...
         ("GARAGE / ACCESSORY BLDG, 2 STORY (934 + 822)","EXISTING","1,756 SF", 1756),
...
notes = [
 ...
 "     (60' ROAD; THE W P.L. IS ITS EAST EDGE). N OF THE BEND: EXTERIOR SIDE YARD,",
 "     GREATER OF 35' FROM ℄ OR THE 15' INT. SIDE YARD (PDS-306 P.5) — 15' OFF THE ESMT.",

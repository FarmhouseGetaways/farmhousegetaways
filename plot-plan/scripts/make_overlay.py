...
WL_EDGE_E = [(0.0, 204.0)] + [(round(66.0*(d/90.0)**1.7, 2), 204.0+d)
             for d in [6,12,18,24,30,36,42,48,54,60,66,72,78,84,90]]
WL_EDGE_W = [(x-43.0, y+42.0) for x, y in WL_EDGE_E]
...
ax.set_title("VERIFICATION OVERLAY v10 - plan geometry on registered aerial\n"
             ...
             fontsize=13, pad=10)
fig.savefig("output/Verification_Overlay_v10.png", bbox_inches="tight", dpi=100)
print("saved output/Verification_Overlay_v10.png")

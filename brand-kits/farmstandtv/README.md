...
> EmailOctopus integration. The live site at `farmstandtv.netlify.app` was deployed by
...
> Connect it now and Farmstand.TV becomes a site with no pages.
>
...
3. Check nothing is missing against what is actually live:
   ...
   ```
   curl -sI https://farmstandtv.netlify.app/            # each page you know about
   ```
...
apart by tags. Contacts from this site are tagged `farmstand-tv`, plus a
...
### Check it
    ...
    https://farmstandtv.netlify.app/api/emailoctopus?key=YOUR_ADMIN_PASSWORD
...
`emails/welcome-farmstandtv.html` is the auto-responder that delivers the
...
`farmstandtv` on the trigger. If your plan will not allow that, set

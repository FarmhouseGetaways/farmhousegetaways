...
(function () {
  ...
  /* ---- stance ----------------------------------------------------------- */
  L.stand      = P();
  L.standB     = P({ py: 43.5, torso: 5, head: [3, 15.5, -1], armF: [37, 92], armB: [23, 97], tail: [219, -28, -26] });
  L.standC     = P({ py: 41, torso: 7, head: [3, 14.5, 1], armF: [43, 98], armB: [27, 103], tail: [211, -22, -14] });

  L.walkF1 = P({ py: 41, legF: [34, -30], legB: [-24, 24], armF: [34, 90], armB: [34, 96], torso: 8, tail: [221, -30, -18] });
  L.walkF2 = P({ py: 43, legF: [6, -6], legB: [4, -4], armF: [42, 96], armB: [22, 102], torso: 5 });
  L.walkF3 = P({ py: 41, legF: [-22, 22], legB: [32, -28], armF: [46, 100], armB: [18, 94], torso: 6, tail: [209, -20, -22] });
  L.walkF4 = P({ py: 43, legF: [6, -6], legB: [4, -4], armF: [40, 95], armB: [25, 100], torso: 6 });

  L.walkB1 = P({ py: 41, legF: [-20, 20], legB: [28, -26], armF: [38, 96], armB: [28, 104], torso: 3, tail: [205, -14, -10] });
  L.walkB2 = P({ py: 43, legF: [8, -8], legB: [-4, 4], armF: [41, 95], armB: [25, 100], torso: 4 });
  L.walkB3 = P({ py: 41, legF: [26, -24], legB: [-18, 18], armF: [44, 98], armB: [22, 98], torso: 4, tail: [201, -10, -8] });
  ...
  L.fierce     = P({ torso: 20, px: 4, armF: [98, 0], armB: [4, 124], head: [5, 15, 5],
                     legF: [34, -34], legB: [-24, 22], tail: [221, -34, -24] });
  ...
  L.thrown     = P({ py: 30, torso: -70, head: [-12, 13, -74], armF: [-80, 14], armB: [-88, 10],
                     legF: [-50, 50], legB: [-62, 58], tail: [145, 26, 26] });
  ...
  L.dpRise = P({ py: 52, torso: -8, px: 2, armF: [172, -10], armB: [40, 86],
                 head: [2, 16, -10], legF: [46, -76], legB: [-8, 34], tail: [165, 20, 24] });
  L.dpFall = P({ py: 46, torso: 6, armF: [150, 10], armB: [30, 92],
                 legF: [36, -60], legB: [-14, 40], tail: [181, 8, 14] });
  ...
  L.chargeGo   = P({ py: 34, torso: 44, px: 4, armF: [-40, 40], armB: [-48, 36],
                     head: [8, 13, 22], legF: [70, -110], legB: [-50, 96], tail: [235, -50, -30] });
  ...
  L.teleport = P({ py: 46, torso: 0, armF: [176, 0], armB: [176, 0], head: [2, 16, 0],
                   legF: [10, -12], legB: [-10, 12], tail: [195, 0, 0] });
